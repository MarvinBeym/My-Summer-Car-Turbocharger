...
namespace SatsumaTurboCharger
{
    public class Intercooler_Manifold_Tube_TwinCarb_Part : Part
    {
        ...
        public override PartSaveInfo defaultPartSaveInfo => new PartSaveInfo(){ 
            ...
            position = SatsumaTurboCharger.turbocharger_intercooler_manifold_tube_twinCarb_spawnLocation,
        ...
        protected override void assemble(bool startUp = false){ 
            ...
            if (SatsumaTurboCharger.turbocharger_intercooler_manifold_twinCarb_tube_screwable != null)
            {
                SatsumaTurboCharger.turbocharger_intercooler_manifold_twinCarb_tube_screwable.setScrewsOnAssemble();
            }
        }
        ...
        protected override void disassemble(bool startup = false){ 
            ...
            if (SatsumaTurboCharger.turbocharger_intercooler_manifold_twinCarb_tube_screwable != null)
            {
                SatsumaTurboCharger.turbocharger_intercooler_manifold_twinCarb_tube_screwable.resetScrewsOnDisassemble();
            }
        }
