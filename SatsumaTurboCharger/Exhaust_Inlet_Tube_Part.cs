...
namespace SatsumaTurboCharger
{
    ...
    public class Exhaust_Inlet_Tube_Part : Part
    {
        public Exhaust_Inlet_Tube_Part(PartSaveInfo inPartSaveInfo, GameObject inPart, GameObject inParent, Trigger inPartTrigger, Vector3 inPartPosition, Quaternion inPartRotation) : base(inPartSaveInfo, inPart, inParent, inPartTrigger, inPartPosition, inPartRotation)
        {
