...
namespace SatsumaTurboCharger
{
    ...
    public class TurboChargerHoodPart : Part
    {
        public TurboChargerHoodPart(PartSaveInfo inPartSaveInfo, GameObject inPart, GameObject inParent, Trigger inPartTrigger, Vector3 inPartPosition, Quaternion inPartRotation) : base(inPartSaveInfo, inPart, inParent, inPartTrigger, inPartPosition, inPartRotation)
        {
        ...
        public override PartSaveInfo defaultPartSaveInfo => new PartSaveInfo()
        {
            ...
            position = new Vector3(-16.07559f, 0f, -3.51433849f), //Sets the spawn location -> where i can be found
            rotation = Quaternion.Euler(0.3320142f, -0.00380552025f, 0.00923347753f), // Rotation at spawn location
        };
